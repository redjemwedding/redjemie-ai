      ...
      <div className="grid grid-cols-1 lg:grid-cols-[1fr_320px] gap-6">
        ...
        <div>
          <div className="bg-[#111] border border-white/[.06] rounded-[14px] p-5 sticky top-20">
            ...
            {/* Edit button — admin/instructor only */}
            {(profile?.role === 'admin' || profile?.uid === course.instructorId) && (
              <button onClick={() => nav(`/courses/${courseId}/edit`)}
                className="w-full py-2.5 bg-white/[.04] border border-white/[.08] hover:bg-white/[.07] text-gray-400 hover:text-white font-bold font-[Montserrat] text-[0.78rem] rounded-[10px] transition-colors mb-3 flex items-center justify-center gap-2">
